...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-marginaleffects-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-marginaleffects-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-marginaleffects
# for installing globally
pixi global install r-marginaleffects
```
...
It is possible to list all of the versions of `r-marginaleffects` available on your platform:
...
```
pixi search r-marginaleffects --channel conda-forge
```
